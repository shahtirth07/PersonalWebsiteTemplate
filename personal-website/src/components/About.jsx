    ...
    <section id="about" className="about-section">
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <h2 className="about-subtitle">AI/ML and Network Engineer</h2>
          <p className="about-description">
            I'm an AI/ML and Network Engineer with expertise in building intelligent systems and scalable infrastructure. 
            Currently pursuing my Master's in Computer Science at California State University, Chico, I combine academic knowledge 
            with practical experience to create innovative AI-driven solutions and modernize enterprise systems.
          </p>
